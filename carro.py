...
2) Método acelerar que deverá, que deverá incrementar a velocidade de uma unidade
3) Método frear que deverá incrementar a velocidade em duas unidades.

A Direção teŕa a responsabilidade de controlar a direção. Ela oferece os seguintes
atributos:
